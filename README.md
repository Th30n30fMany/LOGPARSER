PyParser
A lightweight, modular log‑parsing tool for analyzing HTTP, SSH/Telnet, and Firewall logs produced by DShield honeypots.
PyParser reads multiple file formats, normalizes entries into a unified schema, computes metrics, and outputs clean reports.
...
Converts raw logs into a consistent structure regardless of source format.
...
Debug mode  
Print normalized entries as they are processed.
